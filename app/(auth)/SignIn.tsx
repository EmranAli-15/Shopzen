    ...
    return (
        <Container>
            <View>
                    ...
                    <View>
                        ...
                        <View style={{ position: "relative" }}>
                            ...
                            <View style={{ position: "absolute", right: 15, top: 14 }}>
                                ...
                                >
                                    {
                                        showPass ? <Ionicons name="eye-outline" size={24} color="black" /> : <Ionicons name="eye-off-outline" size={24} color="black" />
                                    }
                                </TouchableOpacity>
                            </View>
                        </View>
                ...
                {/* Line devide */}
                <View style={{ flexDirection: "row", alignItems: "center", columnGap: 5, marginVertical: 10 }}>
                ...
                <View>
                    <Text style={{ fontWeight: 500, fontSize: 16 }}>Forget Password?</Text>
                </View>
